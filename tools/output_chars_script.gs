...
function test2() {
  ...
  var start = [0x0000, 0x0080, 0x0370, 0x0400, 0x2000, 0x2100, 0x2150, 0x2190, 0x2200, 0x2300, 0x2500, 0x25A0, 0x2600, 0x3000, 0x818f, 0xff00];
  var end   = [0x007f, 0x00ff, 0x03ff, 0x04ff, 0x206f, 0x214f, 0x218f, 0x21ff, 0x22ff, 0x23ff, 0x257f, 0x25ff, 0x26ff, 0x30ff, 0x818f, 0xffef];
